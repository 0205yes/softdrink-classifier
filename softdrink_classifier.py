...
# 음료별 train data 25개, validation data 5개
...
from set_vars import CLASSES, BATCH_SIZE, EPOCHS, STEPS_PER_EPOCH, VALIDATION_STEPS
...
def generate_image():
    ...
    train_generator = train_datagen.flow_from_directory(
        train_dir, batch_size=BATCH_SIZE, class_mode='categorical', target_size=(150, 150))
    validation_generator = validation_datagen.flow_from_directory(
        validation_dir, batch_size=BATCH_SIZE, class_mode='categorical', target_size=(150, 150))
